...
test.describe("Group 1 Tests", async () => {
    ...
    test.beforeAll(async () => {
        console.log("****Group hooks before all : This runs once before all test cases***")
    })

    test.afterAll(async () => {
        console.log("****Group hooks after all : This runs once after all test cases***")
    })

    test.beforeEach(async () => {
        console.log("---Group hooks before each : This runs once before each test cases***")
    })

    test.afterEach(async () => {
        console.log("---Group hooks after each : This runs once after each test cases***")
    })
